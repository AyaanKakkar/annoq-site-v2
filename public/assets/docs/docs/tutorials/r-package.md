...
[GitHub Repo](https://github.com/USCbiostats/AnnoQR/tree/annoq-site-78-add-hrc-mapping-info)
...
Contributions are welcome! If you encounter any issues or have suggestions for improvements, please open an issue or submit a pull request on the [GitHub repository](https://github.com/USCbiostats/AnnoQR/tree/annoq-site-78-add-hrc-mapping-info).
